...
df %>% group_by(type_1) %>% summarize(weight_kg = mean(weight_kg, na.rm = TRUE))
...
1. `group_by(type_1) %>% summarize(weight_kg = mean(height_m, na.rm = TRUE))` to create the means for method 1 first before piping it to ggplot for plotting
